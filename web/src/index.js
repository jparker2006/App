...
function SignUpFrame() {
    ...
    sPage += "</p>";
    sPage += "<div class='si'>";
    sPage += "<div class='siDivider' style='width: 42%;'>";
    sPage += "<img src='images/windowicon.png' class='si_logo'</img>";
    sPage += "</div>";
    sPage += "<div class='siDivider' style='width: 58%;'>";
...
function LoginFrame() {
    ...
    sPage += "<label class='si_text si_rememberMe' for='Memory'>Stay Logged In</label>"
    sPage += "</div>";
    sPage += "<button class='si_createButton' onClick='checkLogin()'>Login</button>";
    sPage += "</div>";
    sPage += "</div>";
    sPage += "</div>";
    document.getElementById('Main').innerHTML = sPage;
...
function MainFrame() {
    alert(JSON.stringify(g_objUserData));
}
